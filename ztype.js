...
ig.module('game.menus.title').requires('game.menus.base', 'game.menus.detailed-stats', 'game.ease').defines(function() {
    ...
    MenuItemAboutTrainer = MenuItem.extend({
        ...
        ok: function() {
            window.location.href='https://github.com/YassineCherkaoui/ztype_JS_DEV_WORD';
        },
    });
...
ig.module('game.words.en').defines(function() {
    ig.WORDS = ig.WORDS || {};
    ig.WORDS.EN = {
        2: ['api', 'db', 'ui', 'js', 'css', 'oop', 'qa', 'ide', 'vm', 'ci', 'cd', 'iot', 'ai', 'ml', 'git', 'html', 'seo', 'css', 'json', 'sql'],
        3: ['ide', 'api', 'gui', 'sdk', 'oop', 'sql', 'css', 'xml', 'php', 'html', 'dom', 'tcp', 'udp', 'ftp', 'ssh', 'api', 'vpn', 'iot', 'ci/cd', 'json','ide', 'api', 'gui', 'sdk', 'oop', 'sql', 'css', 'xml', 'php', 'html', 'dom', 'tcp', 'udp', 'ftp', 'ssh', 'api', 'vpn', 'iot', 'ci/cd', 'json'],
        4: [
            'byte', 'code', 'loop', 'data', 'file', 'hash', 'heap', 'link',
            'bool', 'char', 'enum', 'void', 'list', 'grid', 'math', 'case',
            'null', 'modu', 'port', 'tree', 'path', 'node', 'time', 'over',
            'load', 'lock', 'name', 'open', 'read', 'sync', 'type', 'user',
            'wait', 'exit', 'fork', 'join', 'goto', 'true', 'func', 'flag',
            'term', 'true', 'goto', 'func', 'enum', 'flag', 'case', 'null',
            'port', 'tree', 'time', 'load', 'lock', 'name', 'open', 'path',
            'term', 'c++', 'java', 'perl', 'ruby', 'bash', 'code', 'html',
            'css', 'json', 'yaml', 'http', 'rest', 'api', 'tcp', 'udp',
            'icmp', 'sql', 'url', 'xml', 'atom', 'byte', 'char', 'disk',
            'jpeg', 'gif', 'png', 'gzip', 'zip', 'bzip', 'tar', 'pdf',
            'dll', 'ide', 'sdk', 'api', 'jit', 'oop', 'rpc', 'git', 'svn',
            'dbms', 'orm', 'html', 'css', 'sass', 'less', 'http', 'ftp',
            'smtp', 'imap', 'pop3', 'smtp', 'dns', 'dhcp', 'icmp', 'ipsec',
            'json', 'yaml', 'xml', 'atom', 'rest', 'soap', 'mqtt', 'smtp',
            'imap', 'pop3', 'ldap', 'oauth', 'saml', 'rest', 'crud', 'soap',
            'rest', 'api', 'url', 'json', 'yaml', 'xml', 'ldap', 'soap',
            'crud', 'mvc', 'orm', 'html', 'css', 'json', 'yaml', 'xml',
            'ajax', 'crud', 'api', 'rest', 'soap', 'atom', 'json', 'yaml',
            'ajax', 'crud', 'api', 'rest', 'soap', 'atom', 'json', 'yaml',
            'byte', 'code', 'loop', 'data', 'file', 'hash', 'heap', 'link',
            'bool', 'char', 'enum', 'void', 'list', 'grid', 'math', 'case',
            'null', 'modu', 'port', 'tree', 'path', 'node', 'time', 'over',
            'load', 'lock', 'name', 'open', 'read', 'sync', 'type', 'user',
            'wait', 'exit', 'fork', 'join', 'goto', 'true', 'func', 'enum',
            'flag', 'path', 'node', 'term', 'loop', 'data', 'byte', 'hash',
            'heap', 'bool', 'char', 'void', 'list', 'grid', 'math', 'null',
            'port', 'tree', 'time', 'over', 'lock', 'read', 'sync', 'user',
            'wait', 'file', 'link', 'fork', 'join', 'true', 'goto', 'func',
            'enum', 'flag', 'case', 'null', 'port', 'tree', 'time', 'load',
            'lock', 'name', 'open', 'path', 'term', 'loop', 'data', 'byte',
            'hash', 'heap', 'bool', 'char', 'void', 'list', 'grid', 'math',
            'null', 'time', 'over', 'lock', 'read', 'sync', 'user', 'wait',
            'file', 'link', 'fork', 'join', 'true', 'goto', 'func', 'enum',
            'flag', 'case', 'null', 'port', 'tree', 'time', 'load', 'lock',
            'name', 'open', 'path', 'term'
        ],
